# Purpose of the Code
# The code aims to loop through a list of dictionaries, where each dictionary 
# represents information about a student in the Harry Potter universe. 
# It prints the name, house, and associated animal for each student, 
# separating these values by a comma.
